...
$string['clicktoenlarge'] = 'Büyük halini açmak için bir ekran görüntüsüne tıklayın, sonra oklarla diğerlerine geçin.';
$string['setting:recordingthumbwidth'] = 'Albüm küçük görüntü genişliği (piksel)';
$string['setting:recordingthumbwidth_desc'] = 'Albümde gösterilen her ekran görüntüsünün küçük kopyasının genişliği. Bir küçük görüntü yaklaşık 10 KB olduğundan, ekran görüntüsünün kapladığı yere yaklaşık onda bir ekler. İzin verilen aralık: 80 - 640.';
$string['albumheading'] = 'Çekilme sırasına göre ekran görüntüleri';
$string['albumcount'] = '{$a} ekran görüntüsü, en eskisi başta. Büyük halini açmak için birine tıklayın; ardından oklarla ya da sol/sağ tuşlarıyla diğerlerine geçebilirsiniz.';
