...
$string['clicktoenlarge'] = 'Click a screenshot to open it full size, then move between them with the arrows.';
$string['setting:recordingthumbwidth'] = 'Album thumbnail width (pixels)';
$string['setting:recordingthumbwidth_desc'] = 'Width of the small copy of each screenshot shown in the album. A thumbnail is about 10 KB, so it adds roughly a tenth to what a screenshot costs. Allowed range 80 to 640.';
$string['albumheading'] = 'Screenshots in order';
$string['albumcount'] = '{$a} screenshots, oldest first. Click one to open it full size, then use the arrows or the left and right keys to move between them.';
