...
/**
 * Access for the quizaccess_invigilator plugin.
 *
...
$capabilities = array(
    'quizaccess/invigilator:sendscreenshot' => array(
        'captype' => 'write',
    ...
    'quizaccess/invigilator:getscreenshot' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'quizaccess/invigilator:viewreport' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Delete images from screenshot logs.
    'quizaccess/invigilator:deletescreenshot' => array(
